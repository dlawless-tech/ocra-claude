#!/bin/bash
# Fill, save, verify and approve one NORMS Grubhub journal entry.
#
...
#   id is the TransactionId; see ../norms-ubereats/R365-AUTOMATION.md.
...
WORK="${3:-${NORMS_GRUBHUB_WORK:-./work.json}}"
